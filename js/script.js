(function () {
  ...
  var translations = {
    en: {
      ...
      pf_1_title: "Hair Salon Website",
      pf_1_meta: "Beauty & booking experience",
      pf_2_title: "Plumbing Services Website",
      pf_2_meta: "Local service & lead generation",
      pf_3_title: "Booking Platform",
      pf_3_meta: "Scheduling & automation",
      pf_4_title: "Law Firm Website",
      pf_4_meta: "Professional legal presence",
      pf_5_title: "Appointment Scheduling App",
      pf_5_meta: "Mobile app & productivity tool",
      aria_pf_1: "Hair Salon Website, view project",
      aria_pf_2: "Plumbing Services Website, view project",
      aria_pf_3: "Booking Platform, view project",
      aria_pf_4: "Law Firm Website, view project",
      aria_pf_5: "Appointment Scheduling App, view project",
      ...
      builder_wizard_lead: "Shape your brand, look, and services — watch the preview come alive.",
      ...
      builder_logo_hint: "PNG or JPG, shown in your preview. Stored in this session only.",
    ...
    gr: {
      ...
      pf_1_title: "Ιστοσελίδα κομμωτηρίου",
      pf_1_meta: "Ομορφιά & εμπειρία κρατήσεων",
      pf_2_title: "Ιστοσελίδα υδραυλικών",
      pf_2_meta: "Τοπικές υπηρεσίες & lead generation",
      pf_3_title: "Πλατφόρμα κρατήσεων",
      pf_3_meta: "Προγραμματισμός & αυτοματισμός",
      pf_4_title: "Ιστοσελίδα δικηγορικού γραφείου",
      pf_4_meta: "Επαγγελματική νομική παρουσία",
      pf_5_title: "Εφαρμογή ραντεβού",
      pf_5_meta: "Εφαρμογή κινητού & παραγωγικότητα",
      aria_pf_1: "Ιστοσελίδα κομμωτηρίου, προβολή έργου",
      aria_pf_2: "Ιστοσελίδα υδραυλικών, προβολή έργου",
      aria_pf_3: "Πλατφόρμα κρατήσεων, προβολή έργου",
      aria_pf_4: "Ιστοσελίδα δικηγορικού γραφείου, προβολή έργου",
      aria_pf_5: "Εφαρμογή ραντεβού, προβολή έργου",
      ...
      builder_wizard_lead: "Δώστε μορφή στο brand, το στυλ και τις υπηρεσίες — δείτε το preview ζωντανά.",
      ...
      builder_logo_hint: "PNG ή JPG, εμφανίζεται στο preview. Μόνο για αυτή τη συνεδρία.",
